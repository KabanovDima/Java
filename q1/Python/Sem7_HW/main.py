...
# Решение:
# beat = str(input('Введите ритм: '))
# # beat = 'пара-ра-рам рам-пам-папам па-ра-па-да'
# print(beat)

# def beatNoBeat(beat):
#     # print(beat.count('а'))
#     list_beat = beat.split()
#     # print(list_beat)
#     list_1 = []
#     for i in list_beat:
#         sum = 0
...
#     if len(list_1) == list_1.count(list_1[0]): # если длина массива равна кол-ву элементов под индексом [0]
#         return True
#     else:
#         return False

# def printBeatNoBeat (arg):
#     if arg is True:
#         print('Парам пам-пам')
#     else:
#         print('Пам парам')
    
# printBeatNoBeat(beatNoBeat(beat))
...
# num_rows, num_colomns = 6, 6
# print_operation_table(operation, num_rows, num_colomns)